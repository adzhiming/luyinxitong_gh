                    ...
                    <div class="contentpanel">
                        <div class="panel panel-title-head">
                            <table id="basicTable" class="table table-striped table-bordered responsive">
                                ...
                                <tbody>
                                <?php if(is_array($rs)): foreach($rs as $key=>$list): ?><tr role="row" class="odd">
                                     <td><?php echo ($list["n_stationid"]); ?><input name='N_Stationid[]' type='hidden' value="<?php echo ($list["n_stationid"]); ?>"></td>
                                     <td><?php echo ($list["n_boardserialno"]); ?><input name='N_Board[]' type='hidden' value="<?php echo ($list["n_boardserialno"]); ?>"></td>
                                     <td><input type="text" name='LicenseKey[]' value="<?php echo ($list["v_licensekey"]); ?>"></td>
                                     <td><?php echo ($list["licensetype"]); ?></td>
                                     <td><?php echo ($list["tmpnum"]); ?></td>
                        ...
                        <div class=" col-md-12">
	                         <input class="btn btn-info btn-large" type="submit" value="提交注册信息">
	                    </div> 
                    </div><!-- panel -->
                    </form>  
