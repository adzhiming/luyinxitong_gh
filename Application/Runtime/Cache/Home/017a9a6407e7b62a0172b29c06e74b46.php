                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                           ...
                                           <!--  <div class="form-group">
                                                <label class="col-sm-2 control-label">性别 <span class="asterisk">*</span></label>
                                                <div class="col-sm-6">
                                                <select id="sex" data-placeholder="Choose One" class="width100p" required>
                                            ...
                                            <div class="col-sm-6">
                                                <select id="departMent" data-placeholder="Choose One" class="width100p" required>
                                                    <option value="0">请选择</option>
                                                    <?php if(is_array($rs)): foreach($rs as $key=>$list): ?><option value="<?php echo ($list["deptid"]); ?>"><?php echo ($list["deptname"]); ?></option><?php endforeach; endif; ?>
                                                </select>
                                            </div>
                                        </div><!-- form-group -->
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" name="phone" id="phone"  class="form-control" placeholder="本地电话1" required />
                                                </div>
                                            </div><!-- form-group -->
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">本地号码2 <span class="asterisk">*</span></label>
                                                <div class="col-sm-6">
                                                    <input type="text" id="officePhone" name="officePhone" class="form-control" placeholder="本地电话2" required />
                                                </div>
                                            </div><!-- form-group -->
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">本地号码3 <span class="asterisk">*</span></label>
                                                <div class="col-sm-6">
                                                    <input type="text" id="homenum" name="homenum" class="form-control" placeholder="本地电话3" required />
                                                </div>
                                            </div><!-- form-group -->
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">本地号码4 <span class="asterisk">*</span></label>
                                                <div class="col-sm-6">
                                                    <input type="text" id="otherPhone" name="otherPhone" class="form-control" placeholder="本地电话4" required />
                                                </div>
                                            </div><!-- form-group -->
...
$(document).ready( function () {
    ...
    jQuery("#flowers, #sex").select2({
        minimumResultsForSearch: -1
    });
    jQuery("#flowers, #departMent").select2({
        minimumResultsForSearch: -1
    });
})
...
$('.submit').click(function(){
		...
		var phone = Trim($('#phone').val(),'g');
		var officePhone = Trim($('#officePhone').val(),'g');
		var otherPhone = Trim($('#otherPhone').val(),'g');
        var homenum =Trim($('#homenum').val(),'g');
		...
		if(departMent == "0"){
			$('#alertModel').modal('show');
			$('.Alertmessage').html('请选择部门') 
			return;
		}
		 
        if(phone =='' && officePhone =='' && otherPhone=='' && homenum==''){
            $('#alertModel').modal('show');
            $('.Alertmessage').html('至少填入一个号码') 
            return;
        }		
		var url ="phoneBookAdd"
		  $.ajax({
				type:"POST",
				url:url,
				data:{
					 name:name,sex:sex,departMent:departMent,phone:phone,officePhone:officePhone,otherPhone:otherPhone,homenum:homenum,remark:remark 
				},
